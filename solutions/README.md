...
Solutions are provided in Java, and confirmed to work with Java SE 17 on Windows 10, as well as on online platforms like Replit. Solutions are beginner-appropriate and not optimized (e.g., the prime checker in Exercise 10).

The [Java Tutorial by Oracle](https://docs.oracle.com/javase/tutorial/) is an excellent place to start, and its content should be sufficient to solve all the exercises.
...
## Running the Code
1. Download and install the [Java Development Kit (JDK)](https://www.oracle.com/java/technologies/javase-downloads.html) on your machine.
